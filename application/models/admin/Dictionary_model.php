...
class Dictionary_model extends Base_model
{
    public $table = "dictionary";
    var $column_order = array(null,'alphabet','status','date_at'); //set column field database for datatable orderable
    var $column_search = array('alphabet','status','date_at'); //set column field database for datatable searchable 
        ...
        public function count_all()
        {
          ...
          public function action_condition(){
            ...
            if(isset($_GET['type']) && $_GET['type'] == '1'){
                ...
                $this->db->where('date_at<=', $curentdate);
                $this->db->where('date_at>=', $fromdate);
            }
