...
{   
    ...
    var $column_order = array(null,'txn_id','order_id','status','dt'); //set column field database for datatable orderable
    var $column_search = array('txn_id','order_id','status','dt'); //set column field database for datatable searchable 
