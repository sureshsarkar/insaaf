...
class Latest_News_model extends Base_model
{
    public $table = "news";
    var $column_order = array(null,'news_cat','expert','dt'); //set column field database for datatable orderable
    var $column_search = array('news_cat','expert','dt'); //set column field database for datatable searchable 
