...
class Acts_model extends Base_model
{
    public $table = "acts";
    var $column_order = array(null,'acts.title','act_type','ac.title','asc.title','dt'); //set column field database for datatable orderable
    var $column_search = array('acts.title','act_type','ac.title','asc.title','dt'); //set column field database for datatable searchable 
