...
class Testimonial_model extends Base_model
{
    ...
    var $column_order = array(null,'title','act_type','ac.title','title','dt'); //set column field database for datatable orderable
    var $column_search = array('title','act_type','ac.title','title','dt'); //set column field database for datatable searchable 
