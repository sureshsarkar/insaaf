...
class Case_category extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->loadViews("admin/case_category/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->loadViews("admin/case_category/addnew", $this->global, $data , NULL);   
    } 
    // delete category 
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
           ...
           // $row[] = (!empty($currentObj->parent_id) && isset($parentCategoryList[$currentObj->parent_id]))?$parentCategoryList[$currentObj->parent_id]:'';
            ...
            $row[] = $date_at;
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'admin/case_category/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a> &nbsp;&nbsp; <a class="btn btn-sm btn-danger deletebtn" href="javascript:void(0)" title="delete"  data_id="'.$currentObj->id.'" ><i class="fa fa-trash"></i></a> ';
    ...
    public function edit($id = NULL)
    {
        ...
        $this->loadViews("admin/case_category/edit", $this->global, $data , NULL);
