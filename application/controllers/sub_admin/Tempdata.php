...
//  This is default constructor of the class
    ...
    {   
      ...
      $query =  $this->db->from("campan")->where('tempData !=', null)->where('seen =', 0)->get();
       $get_tem= $query->result();
        ...
        $this->loadViews("sub_admin/tempdata/list", $this->global, NULL , NULL ,'sub_admin');
    ...
    public function addnew()
    {
        ...
        $this->loadViews("sub_admin/tempdata/addnew", $this->global, NULL , NULL ,'sub_admin');   
    } 
...
// exit();
         ...
         else
         {
            ...
            if(isset($form_data['next_date']) && $form_data['next_time']){
             ...
             if($result > 0)
             {
                 ...
                 redirect('sub_admin/tempdata');
             }
             else
             { 
                 $this->session->set_flashdata('error', 'Follow up Addition failed');
             }
             redirect('sub_admin/tempdata/addnew');
           }  
    ...
    {  
        ...
        foreach ($list as $currentObj) {
         ...
         if(isset($category) && !empty($category)){
            ...
            $row[] = $date_at.$new;
            $row[] = '<a class="btn btn-sm btn-info " style="margin-bottom: 4px;" href="'.base_url().'sub_admin/tempdata/view/'.$currentObj->id.'" title="edit"  data_id="'.$currentObj->id.'" ><i class="fa fa-eye"></i></a>';
            $data[] = $row;
        }
        }
    ...
    public function view($id = NULL)
    {
        ...
        $this->loadViews("sub_admin/tempdata/view", $this->global, $data , NULL ,'sub_admin');    
     ...
     public function update()
     {
         ...
         else
         {
            ...
            $result = $this->campan_model->save($updatetData);
             ...
             redirect('sub_admin/tempdata/edit');
           }  
