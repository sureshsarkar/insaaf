...
<html>
    <body>
        <table border="0" align="center" width="100%" cellpadding="0" cellspacing="0" style="width:100%; margin: auto;">
            <tbody>
                <tr>
                    <td style="padding: 23px 0px; background: white; box-shadow: 0px 0px 3px 0px #bcc3bf;">
                        <table border="0" align="center" width="100%" cellpadding="0" cellspacing="0" style="width:100%; padding: 0px 40px 10px 40px; margin: auto;">
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td style="width: 360px;">
                                        <table style="width: 99%;padding:20px; font-family: system-ui; font-size: 15px; height: 120px; border: 2px solid #d49c11;">
                                            ...
                                            <tr>
                                                <td colspan="2" style="text-align: left;"><a href="'.$orderData->email.'">'.$orderData->email.'</a></td>
                                            </tr>
                                           '.$gstNumber.'
                                        </table>
                                        <!-- end -->
                        ...
                        <table border="0" align="center" width="100%" cellpadding="0" cellspacing="0" style="width: 800px; padding: 8px 40px; margin: auto;">
                            <tbody style="padding-top: 20px;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 10px; text-align: right; font-family: system-ui; border-bottom: 2px solid #d49c11; border-right: 2px solid #d49c11; text-align: center;">'.$total_amt.''."/-".'</td>
                                </tr>
                                <tr>
                                <th style="background-color: #d49c11; font-family: system-ui; font-weight: 300; text-align: center; padding: 10px; color: #fff;">Payment Status</th>
                                    <td style="padding: 10px; text-align: right; font-family: system-ui; border-bottom: 2px solid #d49c11; background: #29d523; text-align: center;">'.$payment_status.'</td>
                                    <td style="padding: 10px; text-align: right; font-family: system-ui; border-bottom: 2px solid #d49c11; text-align: center;"></td>
                                    <td style="padding: 10px; text-align: right; font-family: system-ui; border-bottom: 2px solid #d49c11; border-right: 2px solid #d49c11; text-align: center;"></td>
                                </tr>
                            </tbody>
                        </table>
