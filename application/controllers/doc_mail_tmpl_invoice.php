...
$additional = json_decode($orderData->additional,true);
...
$orderUserName=$additional['addtional']['first_name'].' '.$additional['addtional']['last_name'];
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width:50%; border: 2px solid #d49c11; padding: 8px;">
                                        <table style="width: 99%; font-family: system-ui; font-size: 15px;">
                                            <tr>
                                                <td colspan="2" style="text-align: left;font-weight: 600;">Transaction ID:</td>
                                                <td colspan="2" style="text-align: right; float: right;">'.$invoiceRayzorpayPayId.'</td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" style="text-align: left;font-weight: 600;">Order Date:</td>
                        ...
                        <table border="0" align="center"  cellpadding="0" cellspacing="0" style="width:100%; padding: 0px 40px; margin: auto;">
                            <tbody style="padding-top: 20px;">
                                <tr>
                                  ...
                                  <td style="padding: 10px; text-align: right; font-family: system-ui; border-right: 2px solid #d49c11; text-align: left; width: 50%;">- Rs. '.$additional['addtional']['price'].'/-</td>
                               </tr>
                                <tr>
                                  <td style="padding: 10px 10px 10px 23px; font-family: system-ui; color: #000; border-left: 2px solid #d49c11;font-weight: 600;width: 50%;">Discount<span>('.$additional['addtional']['discount'].'%)</span></td>
                                  <td style="padding: 10px; text-align: right; font-family: system-ui; border-right: 2px solid #d49c11; text-align: left; width: 50%;">- Rs. '.$additional['addtional']['save_price'].'/-</td>
                               </tr>
                                <tr>
                                  <td style="padding: 10px 10px 10px 23px; font-family: system-ui; color: #000; border-left: 2px solid #d49c11;font-weight: 600;width: 50%;">GST<span>('.$additional['addtional']['gst'].'%)</span></td>
                                  <td style="padding: 10px; text-align: right; font-family: system-ui; border-right: 2px solid #d49c11; text-align: left; width: 50%;">- Rs. '.$additional['addtional']['gst_price'].'/-</td>
                               </tr>
                                <tr>
                                  ...
                                  <td style="padding: 10px; text-align: right; font-family: system-ui;border-right: 2px solid #d49c11; text-align: left; width: 50%;">- Rs. '.$additional['addtional']['gross_price'].'/-</td>
                               </tr>
                            </tbody>
                        </table>
                        <table border="0" align="center"  cellpadding="0" cellspacing="0" style="width:100%; padding: 0px 40px; margin: auto;">
