...
class Category extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->loadViews("admin/category/list", $this->global, NULL , NULL ,'admin');
    ...
    public function addnew()
    {
        ...
        $this->loadViews("admin/category/addnew", $this->global, $data , NULL ,'admin');   
    } 
    // delete category 
    ...
    {    
        ...
        foreach ($list as $currentObj) {
          ...
          //  $row[] = '<img src ="'.base_url().'uploads/category/'.$currentObj->image.'" width="50" alt = "'.$currentObj->name.'"/>';
            ...
            $row[] = $date_at;
            $row[] = '<a class="btn btn-sm btn-info" style="margin:4px; 0px;" href="'.base_url().'admin/category/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a> &nbsp;&nbsp; <a class="btn btn-sm btn-danger deletebtn"  href="javascript:void(0)" title="delete"  data_id="'.$currentObj->id.'" ><i class="fa fa-trash"></i></a> ';
    ...
    public function edit($id = NULL)
    {
        ...
        $this->loadViews("admin/category/edit", $this->global, $data , NULL ,'admin');
