...
class Refresh extends BaseController
{
    ...
    {   
        ...
        $upcomingmeetings= $this->client_query_model->rawquery($sql);
         ...
         // new Payment Refund Request
         $sql = "SELECT id FROM payment_refund WHERE seen = '0' ";
         $newPaymentRefund = $this->client_query_model->rawQuery($sql);
        ...
        $data = array(
            ...
            'newPaymentRefund' => count($newPaymentRefund),
