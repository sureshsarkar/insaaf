...
//  This is default constructor of the class
    ...
    public function index()
    {
        ...
        $this->loadViews("admin/calling/list", $this->global, NULL , NULL ,'admin');
    }
    ...
    public function addnew()
    {
        ...
        $this->loadViews("admin/calling/addnew", $this->global, NULL , NULL ,'admin');   
    } 
...
// exit();
    ...
    public function delete()
    {
        ...
        $result = $this->calling_model->delete($id);
    ...
    {  
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = $date_at.$new;
            $row[] = '<a class="btn btn-sm btn-info " style="margin-bottom: 4px;" href="'.base_url().'admin/calling/edit/'.$currentObj->id.$ppc.'" title="edit"  data_id="'.$currentObj->id.'" ><i class="fa fa-pencil"></i></a>&nbsp;&nbsp; <a class="btn btn-sm btn-danger deletebtn" style="margin-bottom: 4px;" href="javascript:void(0)" title="delete"  data_id="'.$currentObj->id.'" ><i class="fa fa-trash"></i></a> ';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->loadViews("admin/calling/edit", $this->global, $data , NULL ,'admin');    
