...
class View_client extends BaseController
{
    ...
    {   
        ...
        $data['view'] = $this->Client_model->find($id);
            ...
            /* code for total case in a perticular client */
            $where = array();
            $where['client_id']    = $id;
            $table    = 'cases';
            $toatalproduct = $this->Case_details_model->findByTable($where,$table);
            if(!empty($toatalproduct)){
               
                $data['caseCount'] =  count($toatalproduct) ;   
            }

            /* end code for counting year sales */
        $this->global['pageTitle'] = 'view_client';
        $this->loadViews("admin/view_client", $this->global, $data , NULL ,'admin');
    }  
    /**
    ...
    function userListing()
    {
        ...
        else
        {
            ...
            $this->loadViews("users", $this->global, $data, NULL,'admin');
        }
    }
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->loadViews("addNew", $this->global, $data, NULL,'admin');
        }
    }
     ...
     */
     ...
     public function demo1(){
        $this->loadViews("admin/dashboard", $this->global , NULL ,'admin');
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->loadViews("editOld", $this->global, $data, NULL ,'admin');
        }
    }
