...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletebtn", function() {
        ...
        currentRow = $(this);
        hitURL = "<?php echo base_url() ?>admin/contact/delete";
...
$(document).ready(function() {
    $("#shortBtn").change(function() {
        ...
        url = url + 'admin/contact?type=' + sortBy;
...
function _fnGetTableData() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/contact/ajax_list')?>" + getcontact_data,
            "type": "POST"
        },
...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletByCheck", function() {
        ...
        if (allVals.length > 0) {
            var hitURL = "<?php echo base_url() ?>admin/contact/deleteByCheck";
            $.ajax({
                type: 'POST',
                url: hitURL,
                data: {
...
$(document).ready(function() {
    $(".find_by_date").click(function() {
        ...
        var url = "<?php echo base_url();?>";
        url = url + 'admin/contact?type=daterangefilter&from_date=' + from_date + '&to_date=' +
            to_date;
        window.location.href = url;
    });
});
