                    ...
                    <div class="col-md-11 m-auto">
                                    ...
                                    <tbody>
                                       ...
                                       <?php if(isset($view_data->attachment) && !empty($view_data->attachment)){ ?>
                                        <tr>
                                            <th>Attachment</th>
                                            <td>: <b>
                                                  <a class="" href="<?php echo base_url('uploads/contact/').$view_data->attachment?>" title="View" target="_blank">view <i class="bi bi-box-arrow-up-right"></i>
                                                 </a>
                                                 </b>
                                            </td>
                                        </tr>
                        ...
                        <div class="__flx_button_prv_nxt" style="width:99%">
                            <div class="__bck_butn">
                                <a href="<?=base_url()?>admin/contact<?php echo (isset($_GET['ppc_key']) && $_GET['ppc_key'] =='ppc')?'?type=ppc':''?>" class="button_news"> &lt; Back</a>
                            </div>
                        </div>
                    </div>
                </div>
