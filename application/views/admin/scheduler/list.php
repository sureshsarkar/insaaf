...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-sitemap" aria-hidden="true"></i>Scheduler
            ...
            <div class="col-md-12 ">
               ...
               ?>
                ...
                <div class="form-group text-right">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/scheduler/addnew"><i
...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletebtn", function() {
        ...
        currentRow = $(this);
        hitURL = "<?php echo base_url() ?>admin/scheduler/delete";
...
function _fnGetTableData() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/scheduler/ajax_list')?>" + getcontact_data,
            "type": "POST"
        },
