        ...
        <div class="row">
            ...
            <div class="box p-2">
                    <div class="d-flex flex-row m-2">
                        ...
                        <button type="button" class="btn btn-success clickClient" data-value="close">Active Client</button>
  ...
  <script type="text/javascript">
    jQuery(document).ready(function(){
        //$('#example').DataTable();
          ...
          currentRow = $(this);
          hitURL = "<?php echo base_url() ?>admin/client/delete";
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/client/ajax_list')?>",
            "type": "POST"
        },
...
$(document).ready(function() {
    $("#shortBtn").change(function() {
      var sortBy = $(this).val();
        ...
        url = url + 'admin/client?type=' + sortBy;
