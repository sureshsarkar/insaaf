...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <a href="<?php echo base_url();?>admin/Slot_list"> <i class="fa fa-sitemap" aria-hidden="true"></i> Slot</a>
            <small>Edit</small>
        </h1>
    </section>
        ...
        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="time" class="form-control"
                                            readonly="readonly" value="<?php echo $edit_data->time; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="slot_status" id="status">
                                            ...
                                            <option value="2"
                                                <?php echo ($edit_data->slot_status == 2)?'selected':''; ?>>Decline
                                            </option>
                                        </select>
                                    </div>
                                </div>
            ...
            <div class="box-footer">
                ...
                <input type="hidden" name="client_name"
                    value="<?php echo $client_data->fname.' '.$client_data->fname;?>" />
                ...
                <input type="hidden" id="name" name="lawyer_email" value="<?php echo $lawyer_data->email; ?>" />
                <input type="hidden" id="name" name="lawyer_name" value="<?php echo $name;?>" />
                <input type="hidden" id="name" name="meeting_time" value="<?php echo $edit_data->meeting_time;?>" />
