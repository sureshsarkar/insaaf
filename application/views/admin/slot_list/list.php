...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header"> <h3 class="box-title">Filter Meeting Date List
                            <span style="margin-left:10px;">
                                <select id="shortBtn">
                                    <option value="all">Sort By</option>
                                    <option value="all"
                                        <?= (isset($_GET['meet']) && $_GET['meet'] == 'all' )?"selected":''?>>All Data
                                    </option>
                                    <option value="close"
                                        <?= (isset($_GET['meet']) && $_GET['meet'] == 'close' )?"selected":''?>>Active
                                    </option>
                                    <option value="open"
                                        <?= (isset($_GET['meet']) && $_GET['meet'] == 'open' )?"selected":''?>>Pending
                                    </option>
                                    <option value="upcoming"
                                        <?= (isset($_GET['meet']) && $_GET['meet'] == 'upcoming' )?"selected":''?>>Upcoming Meeting
                                    </option>
                                    <option value="1"
  ...
  <script type="text/javascript">
    jQuery(document).ready(function(){
        //$('#example').DataTable();
          ...
          currentRow = $(this);
          hitURL = "<?php echo base_url() ?>admin/Slot_list/delete";
...
$(document).ready(function() {
    $("#shortBtn").change(function() {
      var sortBy = $(this).val();
        ...
        url = url + 'admin/Slot_list/?type=' + sortBy;
  //       alert(url);
  // return fasle;
...
function  _fnGetTableData() {
  ...
  //datatables
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/Slot_list/ajax_list')?>"+ getmeet_data,
            "type": "POST"
        },
