...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <a href="<?php echo base_url();?>admin/lawyer"> <i class="fa fa-sitemap" aria-hidden="true"></i> Lawyer</a>
            <small>Edit</small>
        </h1>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="member_form" action="<?php echo base_url() ?>admin/lawyer/update"
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="state" name="state" class="form-control"
                                            placeholder="Enter state Name" value="<?php echo $edit_data->state;?>">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="city" name="city" class="form-control"
                                            placeholder="Enter city Name" value="<?php echo $edit_data->city;?>">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
...
$(document).ready(function() {
    ...
    $('.category_id').click(function() {
        ...
        // AJAX request
        $.ajax({
            url: '<?=base_url()?>admin/lawyer/ajax_call_case_sub_cat_name',
            method: 'post',
            data: {
                id: val
            },
