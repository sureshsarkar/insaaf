                    ...
                    <div class="col-md-12">
                        ...
                        <div class="__flx_button_prv_nxt" style="width:99%">
                            <div class="__bck_butn">
                                <a href="<?=base_url()?>admin/lawyer" class="button_news"> &lt; Back</a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 m-auto">
                        <div class="for_client__">
                            ...
                            <?php }?>
                            <a href="<?= base_url('admin/lawyer/lawyer_allcase/'.$view_data->id)?>">
                                <button class="pull-right btn btn-primary mt-2">View All</button>
                        </div>
                        </a>
                    </div>
                </div>
