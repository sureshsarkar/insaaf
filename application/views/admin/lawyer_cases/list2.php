...
<div class="content-wrapper">
    ...
    <?php if(!empty($total_cases)){
      ...
      <i class="fa fa-sitemap" aria-hidden="true"></i> Case Details
        ...
        <?php
            ...
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url();?>admin/Case_details/addnew/"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
