...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <a href="<?php echo base_url();?>admin/Case_details/"> <i class="fa fa-sitemap" aria-hidden="true"></i> Add
                New Case</a>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <form role="form" id="member_form" action="<?php echo base_url()?>admin/case_details/insertnow"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control case_category_id" name="case_category_id"
                                            id="case_category_id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="password">Case Sub Category <span
                                                class="text-muted">*</span></label>
                                        <select class="form-control sub_case_category_id" name="case_sub_category_id"
                                            id="sub_case_category_id">
                                            <?php   } ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control lawyer" data-toggle="modal"
                                            data-target="#exampleModalScrollable" id="lawyer"></select>
                                        <!-- Modal -->
    ...
    $('.case_category_id').change(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Add options
                $('.sub_case_category_id').append(
                    '<option  >Select case Sub Category</option>');
                $.each(response, function(index, data) {
                    $('.sub_case_category_id').append('<option value="' + data[
                        'id'] + '">' + data['case_sub_category'] + '</option>');
                });
            }
        });
    });
