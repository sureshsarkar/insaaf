            ...
            <div class="col-xs-12">
                <div class="box p-2">
                    <div class="d-flex flex-row m-2">
                        ...
                        <button type="button" class="btn btn-danger clickCase" data-value="cancel">Cancel</button>
...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletebtn", function() {
        ...
        currentRow = $(this);
        hitURL = "<?php echo base_url() ?>admin/case_details/delete1";
...
$(document).ready(function() {
    $("#shortBtn").change(function() {
        ...
        url = url + 'admin/case_details/?type=' + sortBy;
        //       alert(url);
        // return fasle;
...
function _fnGetTableData() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/case_details/ajax_list1')?>" + getcase_data,
            "type": "POST"
        },
...
$(document).ready(function() {
    $(".find_by_date").click(function() {
        ...
        var url = "<?php echo base_url();?>";
        url = url + 'admin/case_details/?type=daterangefilter&from_date=' + from_date + '&to_date=' +
            to_date;
        window.location.href = url;
    });
});
...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletByCheck", function() {
        $("input:checkbox[name=checkbox]:checked").each(function() {
            allCaseVal.push($(this).val());
            allSlotVal.push($(this).attr("slot-id"));
        })
        if (allCaseVal.length > 0) {
            var hitURL = "<?php echo base_url() ?>admin/case_details/deleteByCheck";
            $.ajax({
                type: 'POST',
                url: hitURL,
                data: {
                    allCaseVal: allCaseVal,
                    allSlotVal: allSlotVal
                },
            }).done(function(res) {
                if (res == 1) {
