     		    ...
     		    <div class="row">
            		<div class="col-md-3 col-2 mt-md-5 mb-3 mt-5">
                        <div class="small-box bg-info ">
                            ...
                            <a href="<?php echo base_url()?>admin/lawyer/view/<?=$id?>" class="small-box-footer">Click to View
                    ...
                    <div class="col-md-3 col-2 mt-md-5 mb-3 mt-5">
                        <div class="small-box bg-info ">
                            ...
                            <a href="<?php echo base_url()?>admin/lawyer_cases/index/<?=$id?>" class="small-box-footer">Click to View
                                <i class="fa fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3 col-2 mt-md-5 mb-3 mt-5">
                        <div class="small-box bg-info ">
                            <div class="inner">
                                <h3><?php echo  (isset($Countshedule))?$Countshedule:'0' ?></h3>
                                <p>Lawyer Scheduler </p>
                            </div>

                            <a href="<?=base_url()?>admin/Lawyer_scheduler/index/<?=$id?>" class="small-box-footer">Click to View
                                <i class="fa fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
