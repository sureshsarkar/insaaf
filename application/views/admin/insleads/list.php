            ...
            <div class="col-xs-12">
                <div class="box p-2">
                    <div class="d-flex flex-row m-2">
                        ...
                        <button class="btn btn-success seenAll" data-seen="seenAll">Seen All</button>
...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletebtn", function() {
        ...
        currentRow = $(this);
        hitURL = "<?php echo base_url() ?>admin/insleads/delete";
...
$(document).ready(function() {
    $(".find_by_date").click(function() {
        ...
        url = url + 'admin/insleads?type=daterangefilter&from_date=' + from_date + '&to_date=' +
            to_date;
...
function _fnGetTableData() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/insleads/ajax_list')?>" + getcontact_data,
            "type": "POST"
        },
...
$(document).ready(function() {
    $(".clickPPC").click(function() {
        ...
        var url = "<?php echo base_url();?>";
        url = url + 'admin/insleads?type=' + sortBy;
        window.location.href = url;
    })
...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletByCheck", function() {
        ...
        if (allVals.length > 0) {
            var hitURL = "<?php echo base_url() ?>admin/insleads/deleteByCheck";
            $.ajax({
                type: 'POST',
                url: hitURL,
                data: {
...
<script>
$(document).ready(function() {
    jQuery(document).on("click", ".seenNew, .seenAll", function() {
