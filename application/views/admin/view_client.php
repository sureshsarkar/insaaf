...
.bg-info {
    background-color: #934090 !important;
}
                ...
                <div class="row">
                    <div class="col-md-3 col-2 mt-md-5 mb-3 mt-5">
                        <div class="small-box bg-info ">
                            ...
                            <a href="<?php echo base_url()?>admin/client/view/<?=$id?>" class="small-box-footer">Click
                                to View
                    ...
                    <div class="col-md-3 col-2 mt-md-5 mb-3 mt-5">
                        <div class="small-box bg-info ">
                            ...
                            <a href="<?php echo base_url()?>admin/Case_details/index/<?=$id?>"
                                class="small-box-footer">Click to View
                                <i class="fa fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
