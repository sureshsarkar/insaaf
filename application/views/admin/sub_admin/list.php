...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <i class="fa fa-sitemap" aria-hidden="true"></i> Sub Admin
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/sub_admin/addnew"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
