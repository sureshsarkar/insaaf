      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <form role="form" id="member_form" action="<?php echo base_url() ?>admin/Hearing_list/update" method="post" role="form" enctype="multipart/form-data"> 
                  <div class="box-body">
                     <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <input type="date" id="name" name ="hearing_date" class="form-control"  value="<?php echo $edit_data->hearing_date; ?>" >
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                              <label for="name">Time</label>
                              <input type="text" id="name" name ="hearing_time" class="form-control"  value="<?php echo $edit_data->hearing_time; ?>" >
                           </div>
                        </div>
                     </div>
                     <div class="row">
         ...
         <input type="hidden" name="case_id" value="<?php echo $edit_data->case_id;?>"/>
         <input type="hidden" name="case_cat_id" value="<?php echo $edit_data->case_cat_id;?>"/>
         <input type="hidden" name="case_sub_cat_id" value="<?php echo $edit_data->case_sub_cat_id;?>"/>
