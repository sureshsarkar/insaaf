        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" id="member_form" action="<?php echo base_url() ?>admin/dictionary/insertnow"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control category_id" name="alphabet" id="alphabet">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="name">Alphabet Hindi</label>
                                                <input class="form-control " name="alphabet_hi">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
