...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <a href="<?php echo base_url();?>admin/sub_category"> <i class="fa fa-sitemap" aria-hidden="true"></i>Sub Category</a>
        <small>Edit</small>
      </h1>
    </section>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php if(!empty($category)) {?>
                                        <div class="form-group">
                                            ...
                                            <select class ="form-control" name="category_id" id="parent_id">
                                                ...
                                                <option  <?php if($cat_value->id==$edit_data->category_id){?> value="<?=$cat_value->id ;?>"  > <?=$cat_value->name ;?></option>
                                                <?php } }?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="slug" name ="sub_category" class="form-control" required="required" placeholder="Sub category"  value="<?php echo $edit_data->sub_category; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="slug">Sub Category in Hindi</label>
                                        <input type="text" id="slug" name ="sub_category_hi" class="form-control" required="required" placeholder="Sub category"  value="<?php echo $edit_data->sub_category_hi; ?>">
                                    </div>
