...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-sitemap" aria-hidden="true"></i>Testimonial
            ...
            <div class="col-md-12 ">
               ...
               ?>
                ...
                <div class="form-group text-right">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/testimonial/addnew"><i
...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletebtn", function() {
        ...
        currentRow = $(this);
        hitURL = "<?php echo base_url() ?>admin/testimonial/delete";
...
$(document).ready(function() {
    jQuery(document).on("change", ".trending", function() {
        ...
        var status = 0;
        hitURL = "<?php echo base_url() ?>admin/testimonial/changestatus";
        if ($(this).is(':checked')) {
            status = 1;
        } else {
            status = 0;
...
function _fnGetTableData() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/testimonial/ajax_list')?>" + getcontact_data,
            "type": "POST"
        },
