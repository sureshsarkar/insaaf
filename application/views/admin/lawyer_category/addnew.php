...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         <a href="<?php echo base_url();?>admin/lawyer_category"> <i class="fa fa-sitemap" aria-hidden="true"></i> Lawyer Category</a>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Add New Lawyer Category</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="member_form" action="<?php echo base_url() ?>admin/lawyer_category/insertnow" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <!--name-->                             
                                    <div class="form-group">
                                        <label for="name">Lawyer Category</label>
                                ...
                                <div class="col-md-6">     
                                    <!-- About  -->
                                    <div class="form-group">
                                         <label for="about">About Lawyer Category</label>
