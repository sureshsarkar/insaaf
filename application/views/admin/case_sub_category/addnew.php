      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <!-- /.box-header -->
               <!-- form start -->
               <form role="form" id="member_form" action="<?php echo base_url() ?>admin/case_sub_category/insertnow" method="post" role="form" enctype="multipart/form-data">
                  <div class="box-body">
                     <div class="row">
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" id="name" name ="case_sub_category" class="form-control" required="required"  placeholder="Enter Sub Category Name" >
                           </div>
                           <div class="form-group">
                              <label for="name">Case Sub Category in Hindi</label>
                              <input type="text" id="name" name ="case_sub_category_hi" class="form-control" required="required"  placeholder="Enter Sub Category Name in Hindi" >
                           </div>
                           <div class="form-group">
