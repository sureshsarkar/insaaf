                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" name ="name" class="form-control" value="<?php echo $edit_data->name; ?>" required="required" placeholder="Enter Product Name" >
                                            </div>   
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                          ...
                                          <?php if(!empty($parent_list)) {?>
                                            ...
                                            <input type="text" id="tag" name ="tag" class="form-control" required="required" placeholder=" " value="<?php echo $edit_data->tag; ?>" >
                                            </div> 
                                            <?php }?>
                                      ...
                                      <!--   <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="no_item" name ="no_item" class="form-control" value="<?php echo $edit_data->no_item; ?>" required="required" placeholder=" " >
                                            </div>   
                                        </div> -->
                                    </div>
                                    <!-- second row -->
                                    ...
                                    <div class="more_product" id="1remove<?=$i?>"  style="background-color:<?php if($i/2==1){echo $even;}else{echo $odd;} ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="price0" name ="price[]" class="form-control" required="required" placeholder=" "  value="<?=$data_price[$i]?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <!--  Price--> 
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="discount0" name="discount[]" onkeyup="get_discount(this)" class="form-control discount" value="<?=$discount[$i]?>" required="required" placeholder=" " >
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <!-- Regular Price--> 
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="regular_price0" name="regular_price[]"  readonly class="form-control regular_price"  value="<?=$regular_price[$i]?>"required="required" placeholder=" " >
                                                </div>   
                                            </div>
                                            <div class="col-md-3">
                                                <!-- Regular Price--> 
                                        ...
                                        <option  <?php echo  ($value->id==$size[$i])?'selected':''; ?>  value="<?=$value->id?>"><?=$value->name?></option>  
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="no_item"> No.Item</label>
                                                    <input type="number" id="no_item" name ="no_item[]" class="form-control" required="required" placeholder=" "  value="<?=$no_item[$i]?>">
                                                </div>   
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="slug_url" name ="slug_url" class="form-control"  value="<?= $edit_data->slug_url?>" placeholder="" >
                                            </div>   
                                        </div>
                                        <div class="col-md-6">
                                            <!--  color--> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="field" align="left">
                                          <input type="file" id="files" name="newfiles[]" multiple />
                                        </div>
                                        <div>
                                        ...
                                        <?php
                                            ...
                                            <span class="pip delete_old_image" data_imagename="<?=$value?>" data_index="<?=$i?>" data_id="spanid_<?=$i?>" id="spanid_<?=$i?>">
                                                <img src="<?php echo base_url(); ?>uploads/product/<?php echo $value;?>" class="imageThumb " data_id="<?=$i?>" data_imagename="<?=$value?>">
                                ...
                                <div class="col-md-6">     
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea  rows="5" id="short_description" name ="short_description"   class="form-control" placeholder="Short Description.." >
                                            <?php echo base64_decode($edit_data->short_description)?></textarea>
                                    </div>
                                    <div class="form-group">
                                         <label for="description"> description </label>
                                        <textarea  rows="8" id="description" name ="description" class="form-control" placeholder="Description.." ><?php echo base64_decode($edit_data->description)?></textarea>
                                    </div>
