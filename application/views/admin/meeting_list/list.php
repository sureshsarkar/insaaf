  ...
  <script type="text/javascript">
    jQuery(document).ready(function(){
        //$('#example').DataTable();
          ...
          currentRow = $(this);
          hitURL = "<?php echo base_url() ?>admin/meeting_list/delete";
...
$(document).ready(function() {
    $("#shortBtn").change(function() {
      var sortBy = $(this).val();
        ...
        url = url + 'admin/meeting_list/?type=' + sortBy;
  //       alert(url);
  // return fasle;
...
function  _fnGetTableData() {
  ...
  //datatables
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/meeting_list/ajax_list')?>"+ getmeet_data,
            "type": "POST"
        },
