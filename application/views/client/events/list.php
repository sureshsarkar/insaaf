...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <i class="fa fa-sitemap" aria-hidden="true"></i> Events
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/Events/addnew"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/events/ajax_list')?>",
            "type": "POST"
        },
