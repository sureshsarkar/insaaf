 ...
 <section class="content">
        <div class="row">
            <div class="col-xs-12 __badge">
              <div class="">
                <div class="box-header __vtx__blue">
                    <h3 class="box-title">  ALL CASE LIST</h3>
                     <div class="box-tools">
...
<script type="text/javascript">
    $(document).ready(function () {
        jQuery(document).on("change", "#no_item", function () {
            ...
            hitURL = "<?php echo base_url() ?>client/product/ajax_list";
            //getlist(Quantity);
            //getlist(Quantity);
            /*  $.ajax({
           url:hitURL,
...
<script type="text/javascript">
    $(document).ready(function () {
        jQuery(document).on("change", ".trending", function () {
            ...
            var status = 0;
            hitURL = "<?php echo base_url() ?>client/product/changestatus";
            if ($(this).is(":checked")) {
                status = 1;
            } else {
                status = 0;
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery(document).on("click", ".deletebtn", function () {
            ...
            currentRow = $(this);
            hitURL = "<?php echo base_url() ?>client/distributor/delete";
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $("#example").DataTable({
            ...
            ajax: {
                url: "<?php echo site_url('client/Dashboard/ajax_list2/').$client_id?>",
                type: "POST",
                data: { start: '1' },
            },
