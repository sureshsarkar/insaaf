                     ...
                     <div class="row">
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <?php if($Categoryname){?>
                              <input type="text" id="name" name ="dt" class="form-control" required="required" placeholder="Enter mobile Name" value="<?php echo $Categoryname; ?>" >
                              <?php }?>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <?php if($Categoryname){?>
                              <input type="text" id="name" name ="dt" class="form-control" required="required" placeholder="Enter mobile Name" value="<?php echo $subCategoryname; ?>" >
                              <?php }?>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <textarea type="file" id="name" name="message" class="form-control" placeholder="Enter mobile Name" value="<?php echo $edit_data->message; ?>" ><?php echo $edit_data->message; ?></textarea>
                           </div>
                        </div>
