                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">
                                    To recover your dues from anyone, you can send a legal notice to notify them with
                                    the help of law. Sending a legal notice is considered useful because it is used as a
                                    warning from the law to the person to repay the amount.
                                    <br>
                                    To get a Recovery Of Dues issued or to know more
                                </p>
