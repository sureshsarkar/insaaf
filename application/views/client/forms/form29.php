                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                ...
                                <p class="p-2 font-text-form">
                                    A proprietorship is a form of business where the owner owns, runs, and controls the
                                    whole enterprise basically means one person company. There are extremely few
                                    compliance requirements because the proprietorship and proprietor are the same,
                                    making it simple to start.
                                    <br>
                                    To get a Proprietorship (one Person Company) issued or to know more
                                </p>
                            ...
                            <div class="box-body">
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Company Address</label><span>*</span>
                                                <input type="mumber" name="addtional[company_address]"
                                                    class="form-control" placeholder="Enter Company Address" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Proprietor Name</label><span>*</span>
                                                <input type="text" name="addtional[proprietor_name]"
                                                    class="form-control" placeholder="Enter Proprietor Name" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Proprietor Address</label><span>*</span>
                                                <input type="mumber" name="addtional[proprietor_address]"
                                                    class="form-control" placeholder="Enter Proprietor Address" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="name">Email</label><span>*</span>
                                                <input type="email" name="addtional[proprietor_email]"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="addtional[proprietor_mobile]"
                                                    class="form-control" placeholder="Enter proprietor mobile" required>
                                            </div>
                                        </div>
                                    </div>
