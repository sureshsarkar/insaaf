                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">
                                    A security deposit is a sum paid by the tenant to the landlord at the beginning of
                                    the lease. The landlord will return the money at the end of the lease or when the
                                    tenant vacates the property, subject to the terms and conditions stipulated in the
                                    lease deed and agreed upon by the parties. The security deposit amount is determined
                                    by the value of the rental property or by state and territory regulations.
                                    <br>
                                    To get a Refund Of Security Notices issued or to know more
                                </p>
                        ...
                        <form role="form" id="member_form" action="<?php echo base_url() ?>client/documentation/payment"
                            ...
                            <div class="box-body">
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="text-center party">Lender</p>
                                        ...
                                        <div class="col-md-6">
                                            <p class="text-center party">Borrower</p>
                                            <div class="form-group">
                                                <label for="name">Name</label><span>*</span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Amt Paid</label><span>*</span>
                                                <input type="text" name="addtional[amt_paid]" class="form-control"
                                                    placeholder="Enter Amt Paid" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Paid for the period of</label><span>*</span>
                                                <input type="text" name="addtional[paid_for_the_period_of]"
                                                    class="form-control" placeholder="Enter Amt Paid" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
