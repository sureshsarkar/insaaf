                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                ...
                                <p class="p-2 font-text-form">
                                    Partition deed, also known as a deed of partition or a partition agreement, is a
                                    legal document that classifies the share and rights of the co-owners in the
                                    undivided property. This Deed represents the portion of each co-owner specifying
                                    their share, marking their portion in an undivided property in order to avoid any
                                    dispute making each of the co-owners as the rightful owner of the property.
                                    <br>
                                    To get your Partition Deed drafted or to know more
                                </p>
                        ...
                        <form role="form" id="member_form" action="<?php echo base_url() ?>client/documentation/payment"
                            ...
                            <div class="box-body">
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label for="name">Owner's Name</label><span>*</span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <h4 class="text-warning"> Co-Owner's Name</h4>
                                            <div class="form-group">
                                                <label for="name">Co-Owner 1</label><span>*</span>
                                                <input type="text" name="second[co_owner_name1]" class="form-control"
                                                    placeholder="Enter Co-Owner Name" required>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <h4 class="text-warning">Share of each Co-Owner</h4>
                                            <div class="form-group">
                                                <label for="name">Co-Owner Share 1</label><span>*</span>
                                                <input type="text" name="second[co_owner_share1]" class="form-control"
                                                    placeholder="Enter Co-Owner Share" required>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="first[label]" value="Owener">
                                    <input type="hidden" name="second[label]" value="Co-Owener">
...
$("#addRow").click(function() {
    ...
    html += '       <label for="name">Co-Owner ' + i + '</label><span>*</span>';
    html += '       <input type="text" name="second[co_owner_name' + i +
        ']" class="form-control" placeholder="Enter Co-Owner Name" required>';
    html += ' </div>';
    html += ' </div>';
    html += ' <div class="col-md-5">';
    html += '    <div class="form-group">';
    html += '      <label for="name">Co-Owner Share ' + i + '</label><span>*</span>';
    html += '      <input type="text" name="second[co_owner_share' + i +
        ']" class="form-control" placeholder="Enter Co-Owner Share" required>';
    html += '    </div>';
    html += '  </div>';
    html +=
