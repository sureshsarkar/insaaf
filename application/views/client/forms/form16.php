                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                ...
                                <p class="p-2 font-text-form">
                                    As businesses grow over time and demand for various services transform, the Indian
                                    law provides numerous opportunities to entrepreneurs to set up one on their own or
                                    in partnership. Setting up a business in partnership is one of the prominent types
                                    with comparatively safer profit analysis, yet risky judgements.
                                    <br>
                        ...
                        <form role="form" id="member_form" action="<?php echo base_url() ?>client/documentation/payment"
                            ...
                            <div class="box-body">
                                ...
                                <div class="for_oosd_documtati__padg">
                                    ...
                                    <div class="row">
                                        <h4 class="text-warning ml-4 mt-0 mb-0"> Colomn1</h4>
                                        <div class="col-md-5">
                                            <div class="form-group">
