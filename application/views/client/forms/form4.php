                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                ...
                                <p class="p-2 font-text-form">
                                    When the owner of a movable or immovable property voluntarily transfers the
                                    possession to someone else legally it is usually done with a gift deed.
                                    Officially a gift deed is drafted when the owner of a movable or immovable property
                                    wishes to transfer the ownership to another person voluntarily. Unlike a will, a
                                    gift deed offers instant transfer without the requirement of visiting the court of
                                    law. Hence, it is considered as a more productive and time saving procedure. It
                                    prevents or avoids, the probable disputes that might arise in the future relating to
                                    the queries of succession or inheritance. <br>
                                    To get your Gift Deed drafted or to know more
                                </p>
                        ...
                        <form role="form" id="member_form" action="<?php echo base_url() ?>client/documentation/payment"
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="email">Age</label><span>*</span>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="email">Age</label><span>*</span>
                                                <input type="email" name="second[age]" class="form-control"
                                                    placeholder="Enter your Age" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="name">Immovable Property</label><span>*</span>
                                                <input type="text" name="addtional[immovable_property]"
                                                    class="form-control" placeholder="Enter Immovable Property"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="name">Movable Assets</label><span>*</span>
                                                <input type="text" name="addtional[movable_assets]" class="form-control"
                                                    placeholder="Enter Movable Assets" required>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="second[label]" value="Beneficiary">
                                </div>
                            </div>
