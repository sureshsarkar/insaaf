                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">
                                    A person can authorize a friend to do certain financial or legal transactions on his
                                    or her behalf. It is a typical practice in situations where the original owner
                                    cannot physically be present, such as when dealing with NRIs or incapacitated
                                    proprietors. They entrust a reliable individual with the authority to conduct
                                    business on their behalf with the power of attorney in this instance.
                                    <br>
                                    To get your General Power of Attorney drafted or to know more
                                </p>
                            ...
                            <div class="box-body">
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p class="text-center party">Attorney</p>
                                            <div class="form-group">
                                                <label for="name">Name</label><span>*</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="second[father_name]" class="form-control"
                                                    placeholder="Enter Husband/Fathers Name" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="text">Age</label><span>*</span>
                                    ...
                                    <div class="row">
                                        <h4 class="text-warning ml-4">Detail of Property</h4>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Detail</label><span>*</span>
                                                <textarea name="addtional[details_of_assets]"
                                                    class="text_field form-control" placeholder="Enter Detail"
                                                    required></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Reason for executing GPA</label><span>*</span>
                                                <input type="text" name="addtional[reason_for_executing_gpa]"
                                                    class="form-control" placeholder="Enter Reason for executing GPA"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
