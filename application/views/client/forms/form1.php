                    ...
                    <div class="container-fluid py-3">
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">Sale Deed is a legal document, which gets executed by the
                                    buyer and the
                                    seller while transferring the ownership of the property. Sale Deed establishes
                                    property ownership which consist the details of buyer and seller, description of
                                    property, sale consideration, transfer of ownership, delivery of possession and
                                    other details.
                                    To get you Sale Deed drafted or to know more</p>
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="name">Total Consideration</label><span>*</span>
                                                <input type="text" name="first[consideration]" class="form-control"
                                                    placeholder="Enter Total Consideration" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">GPA Holder</label><span>*</span>

                                                <input class="form-check-input" type="radio" name="first[gst_holder]"
                                            ...
                                            <div class="form-group">
                                                <label for="name">Title Chain</label><span>*</span>
                                                <input type="text" name="first[tiitle_chain]" class="form-control"
                                                    placeholder="Enter Total Consideration" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="name">Total Consideration</label><span>*</span>
                                                <input type="text" name="second[consideration]" class="form-control"
                                                    placeholder="Enter Total Consideration" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">GPA Holder</label><span>*</span>

                                                <input class="form-check-input" type="radio" name="second[gst_holder]"
                                            ...
                                            <div class="form-group">
                                                <label for="name">Title Chain</label><span>*</span>
                                                <input type="text" name="second[title_chain]" class="form-control"
                                                    placeholder="Enter Total Consideration" required>
                                            </div>
                                        </div>
                                    </div>
