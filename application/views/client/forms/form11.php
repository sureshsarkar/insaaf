                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">
                                    A promissory note is a written agreement in which one party, the promisee, agrees to
                                    pay another party, the promisor, a fixed sum of money at a future date. This can be
                                    done for a variety of reasons. Wherein the promisor has taken a loan from the
                                    promise and promise to pay on mutually agreed time period <br>

                                    To get a Promissory Note issued or to know more
                                </p>
                        ...
                        <form role="form" id="member_form" action="<?php echo base_url() ?>client/documentation/payment"
                            ...
                            <div class="box-body">
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="text-center party">Promiso</p>
                                            ...
                                            <div class="form-group">
                                                <label for="name">F/o:</label><span>*</span>
                                                <input type="text" name="first[F/o]" class="form-control"
                                                    placeholder="Enter care or F/o" required>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <p class="text-center party">Promisee</p>
                                            <div class="form-group">
                                                <label for="name">Name:</label><span>*</span>
                                            ...
                                            <div class="form-group">
                                                <label for="name">F/o:</label><span>*</span>
                                                <input type="text" name="second[F/o]" class="form-control"
                                                    placeholder="Enter care or F/o" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">R/o:</label><span>*</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Amt:</label><span>*</span>
                                                <input type="text" name="addtional[amt]" class="form-control"
                                                    placeholder="Enter Cheque No" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Payment Mode</label><span>*</span>
                                                <input type="text" name="addtional[payment_mode]" class="form-control"
                                                    placeholder="Enter Payment Mode" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Period</label><span>*</span>
                                                <input type="text" name="addtional[period]" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="first[label]" value="Promiso">
                                    <input type="hidden" name="second[label]" value="Promisee">
                                </div>
                            </div>
