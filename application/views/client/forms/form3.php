                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">
                                    An eviction notice is a legal document that is drafted according to the landlord in
                                    order to eject the tenant from his/her premises. This process is known as eviction,
                                    which begins with the delivery of an eviction notice.
                                    However if the terms and conditions mentioned in notice are somehow not agreed upon
                                    or settled among the parties, the situation would then be taken forward in a law
                                    courtroom. <br>
                                    To get the Eviction Notice drafted or to know more
                                </p>
                        ...
                        <form role="form" id="member_form" action="<?php echo base_url() ?>client/documentation/payment"
                            ...
                            <div class="box-body">
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="text-center party">Landload</p>
                                        ...
                                        <div class="col-md-6">
                                            <p class="text-center party">Tenant</p>
                                            <div class="form-group">
                                                <label for="name">Name</label><span>*</span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="name">Address of Tenanted Property</label><span>*</span>
                                                <input type="text" name="addtional[tenant_address]" class="form-control"
                                                    placeholder="Enter Address of Tenanted Property" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="name">Rent</label><span>*</span>
                                                <input type="text" name="addtional[rent]" class="form-control"
                                                    placeholder="Enter Rent" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="name">Reason for Eviction</label><span>*</span>
                                                <input type="text" name="addtional[eviction_reason]"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="name">Rent Last Paid</label><span>*</span>
                                                <input type="text" name="addtional[last_rent_pay]" class="form-control"
                                                    placeholder="Enter Rent Last Paid" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="name">Rent Agreement Date</label><span>*</span>
                                                <input type="date" name="addtional[rent_agreement_date]"
