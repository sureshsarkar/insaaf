                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">
                                    A franchise agreement is a contract under which the franchisor grants the franchisee
                                    the right to operate a business, or offer, sell, or distribute goods or services
                                    identified or associated with the franchisor’s trademark. In exchange, the
                                    franchisee makes one-time or periodical payments to the franchisor in the amount,
                                    terms, and conditions established in the franchise agreement. The franchisee may
                                    have to make one-time, monthly, quarterly, or annual payments to the franchisor.
                                    Depending on the type of franchise and payment, the franchisor and franchisee may
                                    agree that such payments are made with different periodicities. Among others, the
                                    franchisee might pay some or all of the following types of payments to the
                                    franchisor: initial franchise fee, continuing royalties on sales, rent, advertising
                                    assistance, or equipment and supplies.<br>

                                    To get a franchise agreement issued or to know more
                                </p>
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="name">Father's/Husband Name:</label><span>*</span>
                                                <input type="text" name="first[father_or_husband_name]"
                                                    class="form-control" placeholder="Enter Father's/Husband Name"
                                                    required>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="name">Father's/Husband Name:</label><span>*</span>
                                                <input type="text" name="second[father_or_husband_name]"
                                                    class="form-control" placeholder="Enter Father's/Husband Name"
                                                    required>
                                            </div>
                                            <div class="form-group">
