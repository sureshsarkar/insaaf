                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">
                                    A dishonoured cheque attracts penalty on the issuer of the cheque. It depends on the
                                    reason for the bounce. If a cheque is dishonoured because funds in the payer's
                                    account were insufficient, it is a criminal offence under the Negotiable Instruments
                                    Act of 1881. And in terms of the provision envisaged under Negotiable Instrument
                                    Act, the payee has to send a Legal Notice to the payer within 30 days from the
                                    issuance of Return memo in other to attract penal action against the payer. <br>
                                    To get a Cheque Bounce Notice issued or to know more
                                </p>
                        ...
                        <form role="form" id="member_form" action="<?php echo base_url() ?>client/documentation/payment"
                            ...
                            <div class="box-body">
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="text-center party">Payee</p>
                                            <div class="form-group">
                                                <label for="name"> Name/Company's Name</label><span>*</span>
                                                <input type="text" name="first[name_or_company_name]"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="first[father_name]" class="form-control"
                                                    placeholder="Enter care or registered of" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">R/o</label><span>*</span>
                                                <input type="text" name="first[registered_of]" class="form-control"
                                                    placeholder="Enter registered of" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <p class="text-center party">Payer/Issues of cheque</p>
                                            <div class="form-group">
                                                <label for="name">Name/Company's Name</label><span>*</span>
                                                <input type="text" name="second[name_or_company_name]"
                                                    class="form-control" placeholder="Enter your Name" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">Father's Name</label><span>*</span>
                                            ...
                                            <div class="form-group">
                                                <label for="name">R/o</label><span>*</span>
                                                <input type="text" name="second[registered_of]" class="form-control"
                                                    placeholder="Enter registered of" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Cheque No</label><span>*</span>
                                                <input type="text" name="addtional[cheque_no]" class="form-control"
                                                    placeholder="Enter Cheque No" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Bank Name</label><span>*</span>
                                                <input type="text" name="addtional[bank_name]" class="form-control"
                                                    placeholder="Enter Amt Paid" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Cheque Dated</label><span>*</span>
                                                <input type="date" name="addtional[cheque_dated]" class="form-control"
                                                    placeholder="Enter Cheque Dated" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Return Memo Date</label><span>*</span>
                                                <input type="date" name="addtional[return_memo_date]"
                                                    class="form-control" placeholder="Enter Return Memo Date" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Interest:</label><span>*</span>
                                                <textarea name="addtional[interest]" class="text_field form-control"
                                                    placeholder="Enter Interest" required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">More Info:</label><span>*</span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="first[label]" value="Payee">
                                    <input type="hidden" name="second[label]" value="Payer/Issues of cheque">
                                </div>
                            </div>
