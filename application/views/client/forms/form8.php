                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">
                                    A formal written notice from the employer informing an employee or a company
                                    informing its vendors that his employment/contract at the current company is ending
                                    is known as a termination notice. It also outlines any compensation or benefits an
                                    employee might be eligible for before departing, as well as the following steps one
                                    need to take.
                                    A notice of termination of employment or a deal or a agreement or a contract or a
                                    letter terminating an employment is usually issued in a formal manner to bring the
                                    contract to an end and to avoid any future ruckus. <br>

                                    To get a Termination Notice issued or to know more
                                </p>
                        ...
                        <form role="form" id="member_form" action="<?php echo base_url() ?>client/documentation/payment"
                            ...
                            <div class="box-body">
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="text-center party">Issuer</p>
                                            ...
                                            <div class="form-group">
                                                <label for="name">C/o or R/o</label><span>*</span>
                                                <input type="text" name="first[care_or_registered_of]"
                                                    class="form-control" placeholder="Enter care or registered of"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <p class="text-center party">Noticee</p>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="name">C/o or R/o</label><span>*</span>
                                                <input type="text" name="second[care_or_registered_of]"
                                                    class="form-control" placeholder="Enter care or registered of"
                                                    required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Reason for Termination</label><span>*</span>
                                                <textarea name="addtional[reason_for_termination]"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Compensation & Benefits going
                                                    farward</label><span>*</span>
                                                <textarea name="addtional[compensation_and_benefits_going_farward]"
                                                    class="text_field form-control"
                                                    placeholder="Enter Compensation & Benefits going farward"
                                                    required></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="first[label]" value="Executant">
                                    <input type="hidden" name="second[label]" value="Attorney">
                                </div>
                            </div>
