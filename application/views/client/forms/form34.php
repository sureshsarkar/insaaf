                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">
                                    A Licence agreement is somewhat of a similar kind to lease, but holds its individual
                                    importance and details. Unlike the lease, a licence does not offer possession of the
                                    property to the tenant and limits the duration until the completion of specified
                                    purpose.
                                    <br>
                                    To get you Lease/license Agreement issued or to know more
                                </p>
                        ...
                        <form role="form" id="member_form" action="<?php echo base_url() ?>client/documentation/payment"
                            ...
                            <div class="box-body">
                                ...
                                <div class="for_oosd_documtati__padg">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="text-center party">Licensor</p>
                                            ...
                                            <div class="form-group">
                                                <label for="name">Licensee</label><span>*</span>
                                        ...
                                        <div class="col-md-6">
                                            <p class="text-center party">Licensee</p>
                                            <div class="form-group">
                                                <label for="name">Name</label><span>*</span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="first[label]" value="Licensor">
                                    <input type="hidden" name="second[label]" value="Licensee">
                                </div>
                            </div>
