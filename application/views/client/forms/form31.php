                        ...
                        <div class="row p-2">
                            <div class="col-md-12 box pb-2">
                                <p class="p-2 font-text-form">
                                    ...
                                    entity. This type of business entity limits owner liability to their shares, limits
                                    the number of shareholders to 50, and restricts shareholders from publicly trading
                                    shares.
                                    <br>
                                    To get a Private Limited Company issued or to know more
                                </p>
