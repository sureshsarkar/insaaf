                    ...
                    <div class="mt-2 mobileDisplay">
                        ...
                        <div class="mobile_box m-1">
                            ...
                            <div class="d-flex flex-row mb-3">
                                ...
                                <div class="p-2">
                                    <ul class="dataList">
                                        <li>: <?php echo date("d M Y",strtotime($value->meeting_time))?></li>
                                        <li>: <?php echo date("h:i A",strtotime($value->meeting_time))?></li>
                                        <li>:
                                            <?php echo ($value->slot_status==1)?'<span class="badge bg-success">Active</span>':'<span class="badge bg-danger">Pending</span>'?>
                                        </li>
                                ...
                                <div class="right__iconer"><a
                                        href="<?= base_url('client/cases/details/'.base64_encode($value->case_id).'?slot_id='.$value->id)?>">
