...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <a href="<?php echo base_url();?>lawyer/client"> <i class="fa fa-sitemap" aria-hidden="true"></i> <?php echo $edit_data->fname .' '; ?><?php echo $edit_data->lname; ?></a>
        <small>Edit</small>
      </h1>
    </section>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name ="password" class="form-control" required="required" placeholder="Enter password Name" value="<?php echo $edit_data->password; ?>">
                                    </div> 
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="name" name="case_file" class="form-control" placeholder="Enter mobile Name" value="<?php echo $edit_data->case_file; ?>" >
                                        </div> 
                                    </div> 
                                    <div class="col-md-4">
                                        <div class="form-group">
