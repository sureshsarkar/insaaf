                            ...
                            <div class="col-md-12">
                                <div class="row date_time_hide">
                                    <div class="col-md-12 _bg_jhewe1">
                                        <div class="dob text-center">Select Date&nbsp;&nbsp;&nbsp;<i
                                ...
                                <div class=" d-flex  bd-highlight mb-3">
                                    <div class="bd-highlight date_time_hide d-flex flex-wrap">
                                        <?php if(isset($schedule_data) && !empty($schedule_data)){ 
                                              foreach($schedule_data as $sch_data){?>
                                ...
                                <form class="needs-validation"
                                    action="<?=base_url()?>client/Dashboard/update_slot" method="post" id="myform">
                                    <div class="dt">
                                    ...
                                    <input type="hidden" class=" " id="lawyer_id" name="lawyer_id"
                                        ...
                                        <input type="hidden" class=" " id="slot_id" name="slot_id"
                                            value="<?php echo  $slot_id?>">
    ...
    $.ajax({
        ...
        success: function(fb) {
            ...
            if (resp.status == 'true1') {
                ...
                $(".conjk").show().html(
                    '<div  class="alert alert-dismissable alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Please Select Date And Time Correctly!</div>'
                );
                return true;
            }
            else if(resp.status == 'true2') {
                $(".__noti").show().html(
                    '<div  class="alert alert-dismissable alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>You have successfully Booked your slot</div>'
                );
                ...
                $(".__noti").show().html(
                    '<div  class="alert alert-dismissable alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Failed to book your slot</div>'
                );
                window.location.href = resp.reload;
                return true;
            }
