...
$config['mTypes'][1] = "Comedy";
$config['mTypes'][2] = "Action";
$config['mTypes'][3] = "Horror";
$config['mTypes'][4] = "Crime";
$config['mTypes'][5] = "Mystery";
$config['mTypes'][6] = "Thriller";
$config['mTypes'][7] = "Romance";
$config['mTypes'][8] = "Family";
$config['mTypes'][9] = "Biography";
$config['mTypes'][10] = "Adventure ";
$config['mTypes'][11] = "Animation";
$config['mTypes'][12] = "Drama";


$config['razPayMode'] = 'LIVE';
$config['razPaykey_id'] = 'rzp_test_NFomDquzAxWGVp';
$config['razSecret'] = '3l7AUAzygOmvRmdMFMYcwaHf';
