    ...
    <section class="content">
        ...
        <section>
        	 <div class="container-fluid">
              <div class="row">
                <div class="col-md-12">
                  <form action="<?php echo base_url('client/create_case/ajax4/'.base64_encode($this->session->userdata('ses_lawyer_id'))); ?>" method="post" onSubmit="return checkLength()">
                    <div class="left___col ___date___top___nsp">
                        <span><i class="fa fa-calendar-check-o" aria-hidden="true"></i> SELECT APPOINTMENT DATE</span>
                    ...
                    <div class="d-flex flex-row">
                        ...
                        ?>
                            ...
                            <label class="btn btn-outline-primary des_btn_colr_fjjjg slot_date_div <?php echo $active;?>" data-id="<?php echo $i; ?>" <?php if(date('D', strtotime($Date. ' + '.$i.' days')) =="Sun") echo 'disabled';?> >
                            <input type="radio" name="schedule_date" class="slot_date_input_<?php echo $i; ?>" data-day="<?php echo date('D', strtotime($Date. ' + '.$i.' days')); ?>" value="<?php echo date('d M Y', strtotime($Date. ' + '.$i.' days')); ?>" <?php echo $checked;  ?> >
                    ...
                    <div class="">
                        <div class="d-flex flex-row">
                            <div class="btn-group btn-group-toggle ___toggle_date put_schedule" data-toggle="buttons">
                    ...
                    <div class="__flx_button_prv_nxt" style="width:90%">
                            <div class="__bck_butn">
                                <a href="<?php echo base_url('client/create_case')?>" class="button_news btn">Back</a>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $.ajax({  
            type: 'POST',
            url: url, 
            data: { schedule_day: schedule_day, lawyer_id: '' , schedule_date: schedule_date },
