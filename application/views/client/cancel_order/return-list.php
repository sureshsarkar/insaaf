...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-sitemap" aria-hidden="true"></i> <?php echo $ListType; ?> Reuturn Order
                                  ...
                                  <div class="data-tables datatable-dark">
                                      <table id="dataTable3" class="text-center">
                                          ...
                                          <tbody>
                                            ...
                                            <?php if(isset($total_reurn_cancel)) { 
                                                $i=1;
                                              foreach ($total_reurn_cancel as $key => $value) {
                                              ...
                                              ?>   <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      ?>
                                                      <?='<a class="btn btn-sm btn-success" href="'.base_url().'/utils/invoices/'.$value->first_name.$value->pdfname.$value->user_id.'invoice.pdf" title="Download"  data_id="'.$value->id.'" ><i class="fa fa-download"></i></a>';?>
                                                      <?php } ?>
