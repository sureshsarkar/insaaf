...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="col-md-5">
           <h1>
      <i class="fa fa-sitemap" aria-hidden="true"></i>Product inventory
        ...
        <div class="col-md-2" style="margin-top: 30px;">
          <select class="form-control" id="no_item">
            <option value="1">Filter by Quantity</option>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
   ...
   jQuery(document).on("change", "#no_item", function(){
    ...
    hitURL = "<?php echo base_url() ?>admin/inventory/ajax_list";
    //getlist(Quantity);
    //getlist(Quantity); 
 /*  $.ajax({
           url:hitURL,
...
<script type="text/javascript">
  $(document).ready(function(){ 
   jQuery(document).on("change", ".trending", function(){
    ...
    var status = 0;
    hitURL = "<?php echo base_url() ?>admin/inventory/changestatus";
    if($(this).is(':checked'))
    {
      status =1;
    }else
  ...
  <script type="text/javascript">
    jQuery(document).ready(function(){
        //$('#example').DataTable();
          ...
          currentRow = $(this);
          hitURL = "<?php echo base_url() ?>admin/inventory/delete";
  ...
  //  getlist();
    ...
    //datatables
      table = $('#example').DataTable({ 
          ...
          "ajax": {
              "url": "<?php echo site_url('admin/Inventry/ajax_list')?>",
              "type": "POST",
              "data": {from:'2022-02-19'}
          },
