...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletebtn", function() {
        ...
        currentRow = $(this);
        hitURL = "<?php echo base_url() ?>sub_admin/tempdata/delete";
...
$(document).ready(function() {
    $(".find_by_date").click(function() {
        ...
        url = url + 'sub_admin/tempdata?type=daterangefilter&from_date=' + from_date + '&to_date=' +
            to_date;
...
function _fnGetTableData() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('sub_admin/tempdata/ajax_list')?>" + getcontact_data,
            "type": "POST"
        },
...
$(document).ready(function() {
    $(".clickPPC").click(function() {
        ...
        var url = "<?php echo base_url();?>";
        url = url + 'sub_admin/tempdata?type=' + sortBy;
        window.location.href = url;
    })
