...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <a href="<?php echo base_url();?>sub_admin/calling"> <i class="fa fa-sitemap" aria-hidden="true"></i>
                Calling</a>
    ...
    <section class="content">
        ...
        <div class="row">
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" data-backdrop="static"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <form class="editData"
                                                            action="<?=base_url('sub_admin/calling/newUpdate')?>"
                                                            method="post">
            ...
            <div class="col-md-12">
                <div class="box-body">
                    <form role="form" id="member_form" action="<?php echo base_url() ?>sub_admin/calling/update"
...
$(document).ready(function() {
    $(".editData").submit(function(e) {
        ...
        var url = "<?=base_url()?>sub_admin/calling/newUpdate";
        $.ajax({
            type: "POST",
            url: url,
            data: formData,
