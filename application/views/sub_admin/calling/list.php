        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>sub_admin/calling/addnew"><i
            ...
            <div class="col-xs-12">
                <div class="box p-2">
                    <div class="d-flex flex-row m-2">
                        ...
                        <button type="button" class="btn btn-warning clickPPC" data-value="upcomming">Upcomming Follow
                            Up</button>
                    </div>
                            ...
                            <span style="margin-left:10px;">
                                <select id="shortBtn">
                                    ...
                                    <option value="upcomming"
                                        <?= (isset($_GET['type']) && $_GET['type'] == 'upcomming' )?"selected":''?>>
                                        Upcomming
                                    </option>
                                </select>
                            </span>
...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletebtn", function() {
        ...
        currentRow = $(this);
        hitURL = "<?php echo base_url() ?>sub_admin/calling/delete";
...
$(document).ready(function() {
    $("#shortBtn").change(function() {
        ...
        url = url + 'sub_admin/calling?type=' + sortBy;
...
function _fnGetTableData() {
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('sub_admin/calling/ajax_list')?>" + getcontact_data,
            "type": "POST"
        },
