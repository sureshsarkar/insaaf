...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletebtn", function() {
        ...
        currentRow = $(this);
        hitURL = "<?php echo base_url() ?>sub_admin/lawyer/delete";
...
$(document).ready(function() {
    $("#shortBtn").change(function() {
        ...
        url = url + 'sub_admin/lawyer?type=' + sortBy;
...
function _fnGetTableData() {
    ...
    ?>
    var getlawyer_data = "<?php echo  isset($_GET['type'])?'?type='.$_GET['type'].$from_date.$to_date:''?>";
    ...
    table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('sub_admin/lawyer/ajax_list')?>" + getlawyer_data,
            "type": "POST"
        },
...
$(document).ready(function() {
    $(".find_by_date").click(function() {
        ...
        var url = "<?php echo base_url();?>";
        url = url + 'sub_admin/lawyer/?type=daterangefilter&from_date=' + from_date + '&to_date=' +
            to_date;
        window.location.href = url;
    });
});
