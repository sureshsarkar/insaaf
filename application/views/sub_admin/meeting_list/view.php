                        ...
                        <div class="for_client__">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    <tbody>
                                        <!-- case details-->
                                        <tr>
                                            <td colspan="2" class="bg-primary text-uppercase"><b>Meeting Details</b>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Case Category</th>
                                        ...
                                        <tr>
                                            <th>Meeting Date </th>
                                            <td>:
                                                <?php echo $date=date('Y-m-d ',strtotime($meeting_Detail->meeting_time))?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Meeting Time </th>
                                            <td>:
                                                <?php echo $time=date('h:i a ',strtotime($meeting_Detail->meeting_time))?>
                                            </td>
                                        </tr>
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=$clientLink?>" target="_blank">
                                                    <div class="btn btn-success">Join</div>
                                                </a></td>
                                        </tr>
                                        <tr>
                                            <th>Lawyer Meeting Link:</th>
                                            <td><a href="<?=$lawyerLink?>" target="_blank">
                                                    <div class="btn btn-success">Join</div>
                                                </a></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>Case File : </th>
                                            <td><a href="<?=base_url().$meeting_Detail->case_file?>"
                            ...
                            <div class="__flx_button_prv_nxt" style="width:99%">
                                <div class="__bck_butn">
                                    <a href="<?=base_url()?>sub_admin/meeting_list/?type=upcoming" class="button_news">
                                        &lt; Back</a>
                                </div>
                            </div>
                        </div>
