...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header"> <h3 class="box-title">Filter Query List
                                <span style="margin-left:10px;">
                                    <select id="shortBtn">
                                        <option value="all">Sort By</option>
                                        <option value="open"
                                            <?= (isset($_GET['type']) && $_GET['type'] == 'open' )?"selected":''?>>Pendding
                                        </option>
                                        <option value="close"
  ...
  <script type="text/javascript">
    jQuery(document).ready(function(){
        //$('#example').DataTable();
          ...
          currentRow = $(this);
          hitURL = "<?php echo base_url() ?>sub_admin/Payment/delete";
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('sub_admin/Payment/ajax_list')?>",
            "type": "POST"
        },
...
$(document).ready(function() {
    $("#shortBtn").change(function() {
      var sortBy = $(this).val();
        ...
        url = url + 'sub_admin/payment?type=' + sortBy;
...
function  _fnGetTableData() {
  var getpayment_data = "<?php echo  isset($_GET['type'])?"?type=".$_GET['type']:''?>";
  //datatables
    table = $('#example').DataTable({ 
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('sub_admin/payment/ajax_list')?>"+ getpayment_data,
            "type": "POST"
        },
