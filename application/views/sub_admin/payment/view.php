                    ...
                    <div class="col-md-10">
                        <div class="for_imffhd">
                            <h4 class="text-uppercase text-center"><b>Client: </b> <b
                                    class="text-warning"><?php echo  (isset($view_data->name) && !empty($view_data->name))? $view_data->name:(isset($view_data->fname))." ".(isset($view_data->lname)); ?></b>
                            </h4>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    <tbody>
                                        <tr>
                                            <th>Client Name</th>
                                            <td>:<?php echo ucfirst(isset($view_data->name)?$view_data->name:$view_data->fname." ".$view_data->lname)?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Email</th>
                                        ...
                                        <tr>
                                            <th>Gender </th>
                                            <td>:<?php $g =$this->config->item('gender'); 
                                             (isset($view_data->gender))? $g[$view_data->gender]:"" ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br>
                        ...
                        <div class="for_client__">
                            ...
                            <div class="__flx_button_prv_nxt" style="width:99%">
                                <div class="__bck_butn">
                                    <a href="<?=base_url()?>sub_admin/payment" class="button_news"> &lt; Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
