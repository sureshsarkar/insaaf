        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/distributor/addnew"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-5">
                <h1><i class="fa fa-sitemap" aria-hidden="true"></i>Distributor</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $("#example").DataTable({
            ...
            ajax: {
                url: "<?php echo site_url('admin/distributor/ajax_list')?>",
                type: "POST",
                data: { quntity: 1 },
            },
