                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <input type="text" id="name" name ="contact_mode" class="form-control" readonly="readonly" value="<?php echo $edit_data->contact_mode; ?>">
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                              <label for="name">Reply</label>
                              <input type="text" id="name" name ="reply" class="form-control" required="required" placeholder="Enter message to concat place" value="<?php echo $edit_data->reply; ?>">
                           </div>
                        </div>
                     </div>
                      <div class="row">
