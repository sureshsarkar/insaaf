    ...
    <section class="content-header">
        <div class="container-fluid ">
            <div class="for_Upk__list_lawyer">
                <i class="fa fa-sitemap" aria-hidden="true"></i> Total Cases
...
$(document).ready(function() {
    var slug =
        "<?= (isset($_GET['type']) && $_GET['type'] == 'pending')?base_url('lawyer/cases/ajax_list?type=pending'):base_url('lawyer/cases/ajax_list') ?>";
    //datatables
