...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <i class="fa fa-sitemap" aria-hidden="true"></i> All Running Cases 
  ...
  <script type="text/javascript">
    jQuery(document).ready(function(){
        //$('#example').DataTable();
          ...
          currentRow = $(this);
          hitURL = "<?php echo base_url() ?>lawyer/runing_cases/delete";
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('lawyer/cases/ajax_list1/'.$lawyer_id)?>",
            "type": "POST"
        },
