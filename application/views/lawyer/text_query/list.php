...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid ">
        ...
        <i class="fa fa-sitemap" aria-hidden="true"></i> Query in Text Form
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Text Query List </h3>
                     <div class="box-tools">
  ...
  <script type="text/javascript">
    jQuery(document).ready(function(){
        //$('#example').DataTable();
          ...
          currentRow = $(this);
          hitURL = "<?php echo base_url() ?>lawyer/Text_query/delete";
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('lawyer/Text_query/ajax_list/'.$lawyer_id)?>",
            "type": "POST"
        },
