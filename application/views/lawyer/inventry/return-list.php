...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-sitemap" aria-hidden="true"></i> Today Reuturn Order
                                  ...
                                  <div class="data-tables datatable-dark">
                                      <table id="dataTable3" class="text-center">
                                          ...
                                          <tbody>
                                            ...
                                            <?php if(isset($total_return_order)) { 
                                                $i=1;
                                              foreach ($total_return_order as $key => $value) {
                                              ...
                                              <tr>
                                                    ...
                                                    <td><?php echo ($value->payment_type==1)?'Online ':'COD'; ?></td>
                                                    <td>
                                                      <?php
                                                        if($value->return_status==2){
                                                          echo 'Process';
                                                        }else if($value->return_status==1){
                                                          echo ' Complete';
                                                        }
                                                      ...
                                                      <?php echo ($value->return_status==2)?'Return':'';?>
                                                    </td>
                                                    <td>
                                                      <span class="text-<?php echo  ($value->payment_status=='Success')?'success':'danger'; ?>">
                                                       ...
                                                       <td>
                                                          <a href="<?php echo  base_url()?>utils/invoices/<?=$value->firstname?><?=$value->pdfname?><?=$value->user_id?>invoice.pdf" title="Download" data_id="<?=$value->user_id?>">
                                                              <i class="fa fa-download"></i>
                                                          </a>
                                                       </td>
                                                   <!--  <td>
                                                      <a href="<?php echo base_url() ?>user/Orderdetails/order_Details?id=<?=$value->id?>" class="">
                                                        <i class="fa fa-eye"></i>
                                                      </a>
                                                    </td> -->
