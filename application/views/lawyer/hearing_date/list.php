...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid ">
        ...
        <i class="fa fa-sitemap" aria-hidden="true"></i> Hearing  List
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Case  Hearing  List </h3>
                     <div class="box-tools">
  ...
  <script type="text/javascript">
    jQuery(document).ready(function(){
        //$('#example').DataTable();
          ...
          currentRow = $(this);
          hitURL = "<?php echo base_url() ?>lawyer/Hearing_date/delete";
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('lawyer/Hearing_date/ajax_list/'.$lawyer_id)?>",
            "type": "POST"
        },
