    ...
    <section class="content-header">
        <div class="container-fluid ">
            <div class="for_Upk__list_lawyer">
                <i class="fa fa-sitemap" aria-hidden="true"></i> Total Meeting
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Total Meeting List </h3>
                        <div class="box-tools">
...
$(document).ready(function() {
    var slug =
        "<?= (isset($_GET['type']) && $_GET['type'] == 'pending')?base_url('lawyer/meeting/ajax_list?type=pending'):base_url('lawyer/meeting/ajax_list') ?>";
    //datatables
