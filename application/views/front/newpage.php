    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body p-3">
                <p class="mb-3">Disclaimer
                    This note is for general information only. It is not to be substituted for legal advice or
...
<div id="">
                            ...
                            <div class="bg_black_conslut_layer">
                                ...
                                <div class="for_nec_cdj_posd">
                                    <div
                                        ...
                                        <div class="p-2">Want to take help? <br>+91-9953536391</div>
    ...
    <!-- lawyer list section end-->
    <section class="bg_next sec_pad2 bg1__ pb-1 ">
        <!--  back1234 -->
        <div class="container">
            <div class="row">
                <div class="col-md-12 ">
                    <h4 class="text-light pb-3 pt-5 bold1 text-center co_text_bsgd">
                        <span
    ...
    <section class="sec_pad">
        <div class="container section_view_mobile">
            <div class="row">
                <div class="col-md-12 ">
                    <h4 class=" pb-3 pt-5 bold1 text-center">
                        <span
    ...
    <section class="bg_next sec_pad bg1__ pb-1 section_view_desktop">
        <div class="container">
            ...
            <div class="row _space653 mt-0">
                <div class="col-md-5">
                    <div class="p-2 bd-highlight text-right mt-4 new_elpis_set_opc"><b><span
            ...
            <div class="row _space653">
                ...
                <div class="col-md-5">
                    ...
                    <div class="p-2 bd-highlight text-left mt-4 new_elpis_set_opc"><b><span
            ...
            <div class="row _space653">
                <div class="col-md-5">
                    <div class="p-2 bd-highlight text-right mt-4 new_elpis_set_opc"><b><span style="    font-size: 1.5rem;
                ...
                <div class="col-md-6">
                    ...
                    <div class="__better65">
                        ...
                        <div class="__query_call justify-content-between">
                            <span><?=$this->lang->line('call_to_cont');?><a href="tel:9953536391"
                                    class="__any354653"><?=$this->lang->line('any_question_cont');?></a></span>
                            <span style="font-size:1.3rem;"><strong>+91-9953536391 / 1800-212-9001</strong></span>
    ...
    <section class="bg-imgag pt-3 bg-img  pb-5">
        <div class="for-borderpp">
            <div class="container-fluid hhff">
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="container-fluid">
                    <div class="row pt-5">
                        ...
                        <div class="col-md-3 mobileSpace">
                            <div class="card">
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="lecs_lind_cdnfty">
                                                ...
                                                <a href="<?=base_url()?>latest-news/<?=$news->slug_url?>"
                                                    class="btn "><?=$this->lang->line('view_more_cont');?><i
