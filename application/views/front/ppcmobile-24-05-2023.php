...
.main_conslt_heding h3 img {
    width: 10%;
}

.main_conslt_heding.text-center p {
    margin-bottom: 0;
}
    ...
    <div class="container">
        <form action="<?=base_url('new_user/pay_for_slot')?>" method="post" onSubmit="return checkLength()">
            <div class="row">
                <div class="col-md-6 col-xl-4 col-lg-4 col-sm-12 firstCon ">
                    ...
                    <div class="form-group chng_emil_box">
                        ...
                        <input type="text" class="form-control fullname" name="fullname"
                            placeholder="Example: Suresh Sarkar" required>
                    ...
                    <div class="form-group chng_emil_box">
                        ...
                        <input type="text" class="form-control mobile" name="mobile" placeholder="Example: 9953536391"
                ...
                <div class="col-md-6 col-xl-4 col-lg-4 col-sm-12 hidden1 secondCon">
                        ...
                        <div class="">
                            ...
                            ?>
                                <label
                                    ...
                                    data-id="<?php echo $i; ?>">
                                    <input type="radio" name="schedule_date" class="slot_date_input_<?php echo $i; ?>"
...
$(document).ready(function() {
    ...
    function _ajaxCall(fullname, mobile, category) {
