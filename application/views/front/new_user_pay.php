...
<form name='razorpayform' action="<?php echo base_url('client/Query_pay_verify');?>" method="POST">
...
options.modal = {
    ondismiss: function() {
        ...
        <?php $error="Payment has been canceled"; ?>
          window.location.href = "<?php echo base_url('welcome?f=Your payment failed. So please make payment to book your slot!');?>";
    },
