        ...
        <div class="for_full_login_backhdf">
            <div class="row">
                                    ...
                                    <form id="form1">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="mobile" placeholder="Enter Phone number" maxlength="10">
                                        </div>
                ...
                <div class="col-md-6 forgotCon _bodyCon hidden ">
                    ...
                    <div class="fkrio_oodfk">
                        <div class="">
                            <h4 class="forgotHeading">Forgot Password </h4>
                        </div>
                        <form id="form2">
                            <div class="form-group">
                                <label for="exampleInputNumber">Phone Number </label>
                ...
                <div class="col-md-6 successCon _bodyCon text-center hidden ">
                    ...
                    <br />
                    <a href="<?= base_url('login')?>" class="btn btn-primary saveBtn">Login Now</a>
                </div>
            </div>
            <!--Success-->
        </div>
