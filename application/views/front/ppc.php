                        ...
                        <div class="lawyer_list_bg">
                            <div class="dis_flc div_2_block">
                                <div class="welcome_lawyer welcome_lawyer_2">
                                    <p><small>Welcome <?= $v->gender?></small></p>
                                    <!-- $config['gender'][1] = "Male";
$config['gender'][2] = "Female";
$config['gender'][3] = "Other"; -->
                                </div>
                                <div class="lawyer_img">
                                    <img src="<?=base_url()?><?php echo (!empty($v->image))?$v->image:"assets/images/mobilehome/".$img.".webp";?>"
                                        alt="">
                                ...
                                <div class="side_text_lawyer_list">
                                    ...
                                    <div class="expriences">
                                        ...
                                        <p><?php echo (!empty($v->language))?$v->language:"Hindi" ;?></p>
                                    </div>
                                    <div class="expriences">
                    ...
                    <div class="back_prict_area">
                        <div class="expriences_2">
                            ...
                            <p class=""><?php echo $v->practice_area?></p>
                        </div>
                    </div>
                    <div class="button_lawyer_list">
                        <a href="#cll_talk_butn"><img src="<?=base_url()?>assets/images/mobilehome/bubble-chat.png"
                                alt="" class="list_chat_lawyer"></a>
                        <a href="#cll_talk_butn"><img src="<?=base_url()?>assets/images/mobilehome/phone-call.png"
                                alt=""></a>
                    </div>
                </div>
            </div>
...
<?php
 ...
 if(isset($device) && $device=='m'){
     $this->load->view('front/ppcmobile', '', '');
    }else{
