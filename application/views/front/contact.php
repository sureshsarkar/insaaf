...
<script src="https://www.google.com/recaptcha/api.js?render=6Leprj8lAAAAAOIo0cFqJ9qYQIjt0-ROmI_m2Gzi"></script>

<script>
        grecaptcha.ready(function() {
          grecaptcha.execute('6Leprj8lAAAAAOIo0cFqJ9qYQIjt0-ROmI_m2Gzi', {action: 'submit'}).then(function(token) {
              // Add your logic to submit to your backend server here.
              var responce =document.getElementById('token_responce');
              responce.value =token;
          });
        });
    ...
    <div class="container for_pad_mar_full">
        <div class="row">
            <div class="col-md-3 col-6">
                <div class="for_icon_desing">
                    <div class="for_border_icon_cont">
                        <a href="https://goo.gl/maps/chPUVppQQaDNUGc67"><img src="<?php echo base_url()?>assets/images/svg/geo-alt-fill.svg" alt=""></a>
                    </div>
            ...
            <div class="col-md-3 col-6">
                <div class="for_icon_desing">
                    <div class="for_border_icon_cont">
                        <a href="tel:(+91-9953536391)" class="fornon_dursdht "><img src="<?php echo base_url()?>assets/images/svg/telephone.svg" alt=""></a>
                    </div>
            ...
            <div class="col-md-3 col-6">
                <div class="for_icon_desing">
                    <div class="for_border_icon_cont">
                        <a href="mailto: contact@insaaf99.com" class="fornon_dursdht "><img src="<?php echo base_url()?>assets/images/svg/envelope-fill.svg" alt=""></a>
                    </div>
                    <div class="for_text_design_cont for_cokdkf_conyt">
            ...
            <div class="col-md-3 col-6">
                <div class="for_icon_desing">
                    <div class="for_border_icon_cont">
                        <a href="https://www.insaaf99.com/" class="fornon_dursdht "><img src="<?php echo base_url()?>assets/images/svg/globe.svg" alt=""></a>
                    </div>
                    <div class="for_text_design_cont for_cokdkf_conyt">
            ...
            <div class="row">
                <div class="col-md-7 dor_so_ckkdfj_oo_cont_us">
                    ...
                    <form action="<?=base_url()?>contact/formsubmit" method="post" id="form1"
                        ...
                        <input type="hidden" name="token_responce" id="token_responce">
                        ...
                        <div class="for_butooon_cont_us">
                            ...
                            data-sitekey="6Lc8mD8lAAAAANXThFpcfbxV_uGOXo7OMV-D19J2" 
