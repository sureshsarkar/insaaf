  ...
  $(document).on('submit','.lawyer_login',function(){
    ...
    $.ajax(
       ...
       if(resp.status =='true'){
        ...
        $(".res").show().html('<div  class="alert alert-dismissable alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button> Please enter valid Email or Password </div>');
        //alert("Please enter valid pass");
       }
...
// alert(url);
  ...
  $.ajax(
   ...
   if(resp.status =='true1'){
    ...
    $(".Register").show().html('<div  class="alert alert-dismissable alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button> Email or Mobile number alrady exist </div>');
    $(".GIF_hide").hide();
    $(".__formHide").show();
    ...
    $(".Register").show().html('<div  class="alert alert-dismissable alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Mobile number alrady exist !</div>');
    $(".GIF_hide").hide();
    $(".__formHide").show();
...
function send_otp(mob){
    ...
    // var url=$(this).attr("action"); 
    var url="http://localhost/web/sync/Sync/web/insaaf99/Lawyer_account/otp_verify"; 
